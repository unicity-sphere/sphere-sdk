...
export const PERMISSION_SCOPES = {
  ...
  NFT_READ: 'nft:read',
  INTENT_NFT_SEND: 'intent:nft_send',
  INTENT_NFT_MINT: 'intent:nft_mint',
} as const;
...
export const METHOD_PERMISSIONS: Record<string, PermissionScope> = {
  ...
  [RPC_METHODS.GET_NFTS]: PERMISSION_SCOPES.NFT_READ,
  [RPC_METHODS.GET_NFT]: PERMISSION_SCOPES.NFT_READ,
  [RPC_METHODS.GET_COLLECTIONS]: PERMISSION_SCOPES.NFT_READ,
  [RPC_METHODS.GET_COLLECTION_NFTS]: PERMISSION_SCOPES.NFT_READ,
};
...
export const INTENT_PERMISSIONS: Record<string, PermissionScope> = {
  ...
  [INTENT_ACTIONS.NFT_SEND]: PERMISSION_SCOPES.INTENT_NFT_SEND,
  [INTENT_ACTIONS.NFT_MINT]: PERMISSION_SCOPES.INTENT_NFT_MINT,
};
