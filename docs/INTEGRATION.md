...
1. [Setup](#setup)
2. [Wallet Composition (v2)](#wallet-composition-v2)
...
**If you stop at Step 1 (base providers only) and pass them directly to `Sphere.init()`, you will have a _legacy wallet that cannot perform v2 mailbox delivery_.**
